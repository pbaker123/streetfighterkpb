...
var characters = [
	...
	},
	{
		...
		audioSrc: "assets/audios/blanka.mpe"
	},
	{
		name: "Guile",
...
$("#game").on("click", $("#start-button"), function() {
	if (buttonControl === 0) {
		buttonControl = 1;
...
$("#game").on("click", ".character-portraits", function(event) {
...
$("#game").on("click", $(".player-attack"), function(event) {
	if (buttonControl === 2) {
		if (currentAttack == "") {
...
// hide the reminder, run a 3 2 1 fight timer
...
function playerAttackImage() {
	...
	console.log("Opponent Image Folder: " + opponentImageFolder)
	console.log("Opponet Image: " + opponentImage)
